...
class WishlistEmptyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final mostPopular = [
      {'img': 'assets/images/profile_most_popular_1.png', 'label': '1780', 'tag': 'New'},
      {'img': 'assets/images/profile_most_popular_2.png', 'label': '1780', 'tag': 'Sale'},
      {'img': 'assets/images/profile_most_popular_3.png', 'label': '1780', 'tag': 'Hot'},
      {'img': 'assets/images/profile_most_popular_4.png', 'label': '1780', 'tag': ''},
    ];
      ...
      body: ListView(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Most Popular', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              GestureDetector(
                onTap: () {},
                child: const CircleAvatar(
                  backgroundColor: Colors.blue,
                  ...
                  child: Column(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(item['img']!, width: double.infinity, height: 90, fit: BoxFit.cover),
                      ),
                      const SizedBox(height: 8),
                      Row(
                        children: [
                          ...
                          if (item['tag']!.isNotEmpty) ...[
                            const SizedBox(width: 4),
                            Text(item['tag']!, style: const TextStyle(fontSize: 12, color: Colors.grey)),
                          ]
                        ],
                      )
                    ],
